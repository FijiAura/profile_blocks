...
package net.hach.profileblocks.gui;
...
public class GuiPFPGrabber extends ElementsProfileBlocksMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiPFPGrabber(ElementsProfileBlocksMod instance) {
		super(instance, 6);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				ProfileBlocksMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private int x, y, z;
		private EntityPlayer entity;
		GuiTextField UsernameYT;
		GuiTextField UsernameGithub;
		...
		public void updateScreen() {
			super.updateScreen();
			UsernameYT.updateCursorCounter();
			UsernameGithub.updateCursorCounter();
		}

		@Override
		protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
			UsernameYT.mouseClicked(mouseX - guiLeft, mouseY - guiTop, mouseButton);
			UsernameGithub.mouseClicked(mouseX - guiLeft, mouseY - guiTop, mouseButton);
			super.mouseClicked(mouseX, mouseY, mouseButton);
		}

		@Override
		protected void keyTyped(char typedChar, int keyCode) throws IOException {
			UsernameYT.textboxKeyTyped(typedChar, keyCode);
			if (UsernameYT.isFocused())
				return;
			UsernameGithub.textboxKeyTyped(typedChar, keyCode);
			if (UsernameGithub.isFocused())
				return;
		...
		protected void actionPerformed(GuiButton button) {
			ProfileBlocksMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
